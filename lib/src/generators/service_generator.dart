...
class ServiceGenerator extends GeneratorForAnnotation<ServiceAnnotation> {
  ...
  void writeExtensionIndex(ServiceExtension ext) {
    ...
    extensions.forEach((e) {
      content = '''import '$kServiceExtensionDirPath/extension_${e.fileName}' as e$space;\n'''
          '''$content'''
  ...
  void writeExtentionForService(ServiceExtension ext) {
    // print(ext);
    var f = File('$kMainExtensionDirPath/$kServiceExtensionDirPath/extension_${ext.fileName}');
